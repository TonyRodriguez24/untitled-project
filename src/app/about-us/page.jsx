export default function AboutUs() {
  return (
    <main className="bg-white text-gray-800 flex flex-col gap-10">
      {/* Hero Section */}
      ...
      <section>
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="py-10">
            ...
            <p className="lg:text-lg mb-6 leading-relaxed">
          ...
          {/* Image / Placeholder */}
          <div>
            <p className="text-2xl font-bold py-4 text-indigo-600">
