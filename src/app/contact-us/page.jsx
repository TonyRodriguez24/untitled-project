      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-1/3 flex flex-col items-center text-center gap-6">
          <Link
            ...
            <h4 className="font-bold text-lg">JPM and Sons</h4>
          ...
          <a
            ...
            <p className="text-gray-700 text-sm">contact@jpmandsons.com</p>
          </a>
          ...
          <a
            ...
            <p className="text-gray-700 text-sm">516-735-0685</p>
          </a>
