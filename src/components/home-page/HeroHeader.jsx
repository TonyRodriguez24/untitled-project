...
export default function HeroHeader() {
  return (
    <div className="flex justify-center items-center">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 w-full max-w-screen-xl  sm:px-8 lg:px-10">
        {/* text section */}
        <div className="flex flex-col gap-2 lg:gap-5 p-8 justify-start col-span-12 lg:col-span-6 bg-amber-800">
